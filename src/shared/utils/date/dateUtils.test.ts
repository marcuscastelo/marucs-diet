...
describe('dateUtils', () => {
  ...
  describe('adjustToTimezone', () => {
    it('should create a copy of the date and adjust timezone', () => {
      ...
      // The function should return a new Date instance
      expect(adjustedDate).toBeInstanceOf(Date)
      expect(adjustedDate).not.toBe(utcDate) // Different object reference
      // The time will be different because of timezone adjustment
