...
export function useMealItemContext() {
    ...
    if (!context) {
        throw new Error('useMealItemContext must be used within a MealItemContextProvider');
    }

    return context;
}

export function MealItemContextProvider({ mealItem, children }: { mealItem: MealItemData, children: React.ReactNode }) {
    return (
