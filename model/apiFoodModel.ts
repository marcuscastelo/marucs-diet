...
export const apiFoodSchema = z.object({
    ...
    pesoAposPreparo: z.number({ required_error: 'Weight after preparation is required' }),
    aprovado: z.boolean({ required_error: 'Approved is required' }),
    padrao: z.boolean({ required_error: 'Standard is required' }),
    possuiFotoTabelaNutricional: z.boolean({ required_error: 'Has nutritional table photo is required' }),
    fotoTabelaNutricional: z.string({ required_error: 'Nutritional table photo is required' }),
    ...
    preco: z.object({
        ...
        precoUsuario: z.object({
            ...
            precoGrama: z.number({ required_error: 'Price per gram is required' }),
    ...
    porcaoPersonalizada: z.object({
        ...
        multiplicador: z.number({ required_error: 'Custom portion multiplier is required' }),
    ...
    porcoes: z.array(
        z.object({
            ...
            multiplicador: z.number({ required_error: 'Portion multiplier is required' }),
...
export type ApiFood = z.infer<typeof apiFoodSchema>;